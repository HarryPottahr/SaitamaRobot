...
I help admins manage their groups with Avadara Kavadara! Have a look at the following for an idea of some of \
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_animation(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="☑️ Add Voldemort to your group",
                     ...
                     [
                         InlineKeyboardButton(
                             text="🗄 Source code",
                             url="https://github.com/HarryPottahr/SaitamaRobot/tree/master/SaitamaRobot")
                     ]]))
    else:
