...
class Config(object):
    ...
    BAN_STICKER = ' CAACAgUAAx0CTvWCVgACAR1gFQV3AikrnMhSeUycg92e2SVoNwAChwEAAmylwVZuzsJPlhC25x4E'  # banhammer marie sticker id, the bot will send this sticker before banning or kicking a user in chat.
